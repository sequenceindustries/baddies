...
export const DUMMY_PASSWORD = "BaddiesDemo123!";
...
export interface DummyPost {
  ...
  // Every id here was hand-checked to contain no people — see
  // fetchPhotoBytes's own comment for why that matters.
  photoId: string;
}

export interface DummyCreatorSpec {
...
// Trimmed to exactly 5 — per explicit product decision, the platform
// shows only this roster and nothing else until real creators join.
export const DUMMY_CREATORS: DummyCreatorSpec[] = [
  {
    slug: "seed-thandeka",
